...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        authentications.put("GatewaySubscriberAuth", new ApiKeyAuth("header", "Proxy-Authorization"));
        authentications.put("GatewaySubscriberAuthNew", new ApiKeyAuth("header", "X-Gateway-Authorization"));
        authentications.put("SubscriberAuth", new ApiKeyAuth("header", "Authorization"));
